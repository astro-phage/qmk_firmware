...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_CTRL] = LAYOUT_ansi_101(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  MACRO_UE,   _______,  _______,            _______,  _______,  _______,  _______, // [ -> ü
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  MACRO_OE, MACRO_AE,             _______,            _______,  _______,  _______,  _______,    _______, // ; -> ö, ' -> ä
